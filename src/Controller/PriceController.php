...
final class PriceController extends AbstractController
{
    ...
    #[Route('/new/{grocery:id}', name: 'app_price_new_with_grocery', methods: ['GET', 'POST'])]
    public function newWithGrocery(Request $request, Grocery $grocery, EntityManagerInterface $entityManager): Response
    {
        $price = new Price();
        $price->setGrocery($grocery);

        $form = $this->createForm(PriceWithGroceryType::class, $price);
        $form->handleRequest($request);
